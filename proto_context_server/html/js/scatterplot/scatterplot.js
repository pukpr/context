...
vq.ScatterPlot.prototype._render = function() {
    ...
    function trans() {
        ...
        if ( dataObj._logScale == 1) {
          var xScale = pv.Scale.log(minX, maxX).nice().range(0, this.width());
          var yScale = pv.Scale.log(minY, maxY).nice().range(0, this.height());
	} else {
...
vq.models.ScatterPlotData.prototype.setDataModel = function () {
    this._dataModel = [
        ...
        {label : '_logScale', id: 'logScale', defaultValue : 1},
