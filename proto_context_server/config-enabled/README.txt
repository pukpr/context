...
config files, which are located in the directory:
    ...
    c:/svn/ontology/reasoners/prolog/cliopatria/config-available

For example, to enhance the system setup   for development, you may wish
to do:

    ==
    ln -s c:/svn/ontology/reasoners/prolog/cliopatria/config-available/debug.pl
    ==

This application may  provide   additional  application-specific example
configuration files.

@see	c:/svn/ontology/reasoners/prolog/cliopatria/config-available/README.txt
