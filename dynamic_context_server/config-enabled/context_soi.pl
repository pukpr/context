...
yearly_qmodul(X,Y) :- Y is 1.0 - 0.15*cos(2*pi*X/12-2.6).
...
*/
    ...
    LongNode is 18.7, % 18.61,
    HalfNode is LongNode/2,

    select_period(Long, 3.89, MfP, PeriodB,1*Add), % 3.91
    ...
    select_period(Long, 5.935, 7.37, PeriodD,0*Add), % 0.5791 5.935 1.77 7.42
    ...
    select_period(Long, 6.42, 9.07, PeriodF,1*Add), % 1.591 3.53
    ...
    select_period(Long, 1.438, 5.65, PeriodG,0*Add), % 3.82
    ...
    Sin9 mapdot mod_sin_period(Period9,-1 ,WL) ~> Months,
    Cos9 mapdot mod_cos_period(Period9,-1 ,WL) ~> Months,
