...
volcanos([
	  ...
	  [78, 0],
          ...
          [328, 25],
          [390, 12], % 1913   384c	   1913	0.538 5.7
          [398, 1], %
          [432, 14], % CerroAzul
          [466, 4], % Katla
          % [396, 6],
          ...
          [911,5],
          % [954,2],
          [1005,28],% 1963   996         1964 1.661 17.7
          % [1019,2],% 1963   996         1964 1.661 17.7
          [1147,6], % 1976   1152        1975 0.682 7.3
          [1210,6], %6x
          [1228,26],% 1982   1224	   1983 1.744 18.6
          [1342,12],   %6x
