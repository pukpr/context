...
volcanos([
          [42, 25],   % Krakatau 1883    4  36      1884 3.33  35.5
	  %[78, 0],   % Okataina
          %[116, 5],  % 1892               1890 0.893 9.5
          % [144, 9], %			   1892 0.48  5.1
          % [202, 6], %                    1896 0.4   4.3
          % [210, 8],   % Mayon
          [275, 19],  % Santa Maria 1902   264         1903 1.654 17.6
          [328, 6],   % 9 Ksudach
          [390, 14],  % Nova Rupta 1913   384c	   1913	0.538 5.7
          % [398, 1],   % Colima
          [434, 7],  % 10 CerroAzul
          % [466, 3],   % Katla
          [530, 4],
          % [637, 1],   % Kharimkotan 1933
          % [852,0],   % Ambryn
          [911,0],    % Bezy
          [1003,21],  % Agung 1963   999         1964 1.661 17.7
          % [1019,0.0], % Shiveluch 1963   996         1964 1.661 17.7
          [1146,4.5],   % Tolbachik 1976   1152        1975 0.682 7.3
          % [1204,1],   % Mt.StHelens 6x
          [1228,20],  % El Chichon 1982   1224	   1983 1.744 18.6
          % [1342,12],   %6x
          % [1346,20]   %6x 1992 1332          1992 2.822 30 *
          [1339,16],  % Pinatubo 6x
          [1341,8]   % Hudson, Cerro 6x 1992 1332          1992 2.822 30 *

	 ]).

volcano_data([
          [krakatoa, 1883,8, 42, 25, 6],   % 22 1883    4  36      1884 3.33  35.5
          % [colima,   1890,6, 126, 4, 4], % 9.5 1892               1890 0.893 9.5
          % [calbuco,  1893,1, 144, 4, 4], % 5.1		     1892 0.48  5.1
          % [mayon,    1897,6, 210, 4.3], %                    1896 0.4   4.3
          [santamaria,1902,10,275, 19, 6],% 1902   264         1903 1.654 17.6
          [ksudach,  1907,4, 328, 6, 5],   % guess
          [novarupta,1912,6, 390, 14, 6], % 5.7 1913   384         1913 0.538 5.7
          % [colima,   1913, 0, 396, 5],
          % [katla, 1918, 3, 465, 4, 4],   % this is actually cerroazul of 5
          [cerroazul,1916,4, 432, 7, 5],  % 4
          % [gao, 1943, 4, 760, 6, ?],
          % [bezymianny,1955,1, 901, 4, 5],
          [agung,    1963,2, 999,21, 5],%17.7  1963   996         1964 1.661 17.7
          % [augustine,1976,0, 1152,2], % 7.3 1976   1152        1975 0.682 7.3
          [elchichon,1982,4, 1228,20, 5],% 18.6 1982   1224	   1983 1.744 18.6
          [pinatubo, 1991,4, 1336,16, 6],   % 1992 1332          1992 2.822 30 *
