...
atmPartialPressureWater(T*Temperature, P*Pressure) :-
   ...
   rdf_(ent:standardAtmosphere, ent:temperature, T0*k),
   rdf_(ent:physicalConstants, ent:gasConstant, R*cal/k/mol),
   rdf_(ent:standardAtmosphere, ent:pressure, P0*atm),
   InvT is 1.0/(T1 + T0),
   rdf_(ent:water, ent:deltaHvap, DeltaHvap*cal),
   rdf_(ent:water, ent:deltaSvap, DeltaSvap*cal/k),
...
atmPressureDryAdiabatic(Alt*Altitude, P*Pressure) :-
   ...
   % var(P),
   rdf_(ent:standardAtmosphere, ent:pressure, P0*atm),
   rdf_(ent:standardAtmosphere, ent:dryAdiabaticPressureHead, Ph*km),
   rdf_(ent:standardAtmosphere, ent:seaLevel, SeaLevel*km),
...
idealPressure(MW*au, D*Mass/Vol^3, T*Temperature, P*Pressure) :-
   ...
   rdf_(ent:physicalConstants, ent:gasConstant, R*j/k/mol),
   P1 is D1*T1*R/MW,
